...
- [Python](questions.md/#Python)
  * [Общие вопросы](questions.md/#Общие-вопросы)
    + [Что такое Python](questions.md/#Что-такое-Python)
    + [Python — это императивный или декларативный язык](questions.md/#Python--это-императивный-или-декларативный-язык)
    + [Когда Python — правильный выбор для проекта](questions.md/#Когда-Python--правильный-выбор-для-проекта)
    + [Когда Python — неправильный выбор для проекта](questions.md/#Когда-Python--неправильный-выбор-для-проекта)
    + [Какие проблемы есть в python](questions.md/#Какие-проблемы-есть-в-python)
    + [Что такое PEP 8](questions.md/#Что-такое-PEP-8)
    + [Что такое виртуальное окружение](questions.md/#Что-такое-виртуальное-окружение)
    + [Что такое docstring?](questions.md/#Что-такое-docstring)
    + [Какие пространства имен существуют в python? Как работает разрешение пространств имен?](questions.md/#Какие-пространства-имен-существуют-в-python-Как-работает-разрешение-пространств-имен)
    + [Что такое Cython? Что такое IronPython? Что такое PyPy? Для чего они нужны?](questions.md/#Что-такое-Cython-Что-такое-IronPython-Что-такое-PyPy-Для-чего-они-нужны)
    + [Чем фреймворк отличается от библиотеки?](questions.md/#Чем-фреймворк-отличается-от-библиотеки)
    + [Что такое сборщик мусора. В чём его плюсы и минусы](questions.md/#Что-такое-сборщик-мусора-В-чём-его-плюсы-и-минусы)
      - [Плюсы сборщика мусора](questions.md/#Плюсы-сборщика-мусора)
      - [Минусы сборщика мусора](questions.md/#Минусы-сборщика-мусора)
    + [Зачем нужен pdb](questions.md/#Зачем-нужен-pdb)
    + [Что такое интроспекция](questions.md/#Что-такое-интроспекция)
    + [Что такое рефлексия](questions.md/#Что-такое-рефлексия)
    + [Python компилируемый или интерпретируемый?](questions.md/#Python-компилируемый-или-интерпретируемый)
    + [Как проверить Python-файл на синтаксические ошибки, но не запускать его](questions.md/#Как-проверить-Python-файл-на-синтаксические-ошибки-но-не-запускать-его)
    + [Для чего используется флаг -O](questions.md/#Для-чего-используется-флаг--O)
    + [Как сделать python-скрипт исполняемым в различных операционных системах](questions.md/#Как-сделать-python-скрипт-исполняемым-в-различных-операционных-системах)
    + [Как ускорить существующий код python](questions.md/#Как-ускорить-существующий-код-python)
    + [Парадигмы программирования в языке Python](questions.md/#Парадигмы-программирования-в-языке-Python)
    + [С помощью каких инструментов можно выполнить статический анализ кода](questions.md/#С-помощью-каких-инструментов-можно-выполнить-статический-анализ-кода)
    + [Как тиражировать python код](questions.md/#Как-тиражировать-python-код)
    + [В чем разница между Python и Java](questions.md/#В-чем-разница-между-Python-и-Java)
    + [Произошла утечка памяти в рабочем приложении. Как бы вы начали отладку?](questions.md/#Произошла-утечка-памяти-в-рабочем-приложении-Как-бы-вы-начали-отладку)
    + [Что такое monkey patching? Приведите пример использования](questions.md/#Что-такое-monkey-patching-Приведите-пример-использования)
    + [Что нужно проверять, когда сервер не работает](questions.md/#Что-нужно-проверять-когда-сервер-не-работает)
  * [Синтаксис](questions.md/#Синтаксис)
    + [Какие типы данных есть в python? На какие классы делятся?](questions.md/#Какие-типы-данных-есть-в-python-На-какие-классы-делятся)
    + [Чем is отличается от двойного равенства (==)](questions.md/#Чем-is-отличается-от-двойного-равенства-)
    + [Что такое тернарный оператор в Python](questions.md/#Что-такое-тернарный-оператор-в-Python)
    + [Есть ли в Python оператор switch-case](questions.md/#Есть-ли-в-Python-оператор-switch-case)
    ...
    + [Что такое аннотации типов, зачем они нужны, когда выполняются](questions.md/#Что-такое-аннотации-типов-зачем-они-нужны-когда-выполняются)
    + [Почему мы пишем __name__ == "__main__" в скрипте Python](questions.md/#Почему-мы-пишем-__name__--__main__-в-скрипте-Python)
  * [Последовательности](questions.md/#Последовательности)
    ...
    + [Что такое интернирование строк](questions.md/#Что-такое-интернирование-строк)
    + [Чем список отличается от кортежа](questions.md/#Чем-список-отличается-от-кортежа)
    + [Что такое диапазон (range)](questions.md/#Что-такое-диапазон-range)
    + [Что такое list comprehension (генератор списков)?](questions.md/#Что-такое-list-comprehension-генератор-списков)
    ...
    + [Какие коллекции из модуля collections знаешь?](questions.md/#Какие-коллекции-из-модуля-collections-знаешь)
    + [В чём преимущества массивов numpy по сравнению с (вложенными) списками python](questions.md/#В-чём-преимущества-массивов-numpy-по-сравнению-с-вложенными-списками-python)
  * [Множества и отображения](questions.md/#Множества-и-отображения)
    ...
    + [Что может являться ключом словаря](questions.md/#Что-может-являться-ключом-словаря)
    ...
    + [Как имплементировать словарь с нуля](questions.md/#Как-имплементировать-словарь-с-нуля)
  ...
  * [Функции](questions.md/#Функции)
    ...
    + [Что такое лямбда-функции? Каковы их особенности](questions.md/#Что-такое-лямбда-функции-Каковы-их-особенности)
    + [Допустимы ли следующие выражения](questions.md/#Допустимы-ли-следующие-выражения)
    + [Как передаются значения аргументов в функцию или метод: по ссылке или по значению](questions.md/#Как-передаются-значения-аргументов-в-функцию-или-метод-по-ссылке-или-по-значению)
    + [Что такое замыкание](questions.md/#Что-такое-замыкание)
    + [Что такое чистая функция?](questions.md/#Что-такое-чистая-функция)
    + [Напишите однострочник, который будет подсчитывать количество заглавных букв в файле](questions.md/#Напишите-однострочник-который-будет-подсчитывать-количество-заглавных-букв-в-файле)
  * [Итераторы и генераторы](questions.md/#Итераторы-и-генераторы)
    + [Что такое контейнер](questions.md/#Что-такое-контейнер)
    + [Что такое итерируемый объект](questions.md/#Что-такое-итерируемый-объект)
    ...
    + [Чем генератор отличается от итератора](questions.md/#Чем-генератор-отличается-от-итератора)
    + [Какие способы есть написать свой генератор](questions.md/#Какие-способы-есть-написать-свой-генератор)
  ...
  * [Классы, объекты](questions.md/#Классы-объекты)
    ...
    + [Что такое магические методы?](questions.md/#Что-такое-магические-методы)
    ...
    + [Что такое \_\_slots\_\_?](questions.md/#Что-такое-__slots__)
    ...
    + [Что такое динамическая типизация](questions.md/#Что-такое-динамическая-типизация)
  ...
  * [Модули, пакеты](questions.md/#Модули-пакеты)
    ...
    + [Как перезагрузить импортированный модуль](questions.md/#Как-перезагрузить-импортированный-модуль)
    + [Что такое менеджер пакетов? Какие менеджеры пакетов вы знаете?](questions.md/#Что-такое-менеджер-пакетов-Какие-менеджеры-пакетов-вы-знаете)
    + [Как упаковать бинарные зависимости](questions.md/#Как-упаковать-бинарные-зависимости)
    + [Что такое wheels и eggs? В чём разница?](questions.md/#Что-такое-wheels-и-eggs-В-чём-разница)
    + [Как получить доступ к модулю, написанному на python из C и наоборот](questions.md/#Как-получить-доступ-к-модулю-написанному-на-python-из-C-и-наоборот)
    + [В чем разница между NumPy и SciPy](questions.md/#В-чем-разница-между-NumPy-и-SciPy)
    + [Назовите несколько модулей Python для статистических, числовых и научных вычислений](questions.md/#Назовите-несколько-модулей-Python-для-статистических-числовых-и-научных-вычислений)
    + [Что такое TkInter](questions.md/#Что-такое-TkInter)
  * [Исключения](questions.md/#Исключения)
    ...
    + [Расскажи про иерархию исключений Python](questions.md/#Расскажи-про-иерархию-исключений-Python)
  ...
  * [Декораторы](questions.md/#Декораторы)
    ...
    + [Какие декораторы из стандартной библиотеки знаешь](questions.md/#Какие-декораторы-из-стандартной-библиотеки-знаешь)
    + [Что делает декоратор property?](questions.md/#Что-делает-декоратор-property)
    + [Чем отличаются декораторы classmethod и staticmethod?](questions.md/#Чем-отличаются-декораторы-classmethod-и-staticmethod)
    + [Напишите декоратор, который будет перехватывать ошибки и повторять функцию максимум N раз](questions.md/#Напишите-декоратор-который-будет-перехватывать-ошибки-и-повторять-функцию-максимум-N-раз)
  ...
  * [Функциональное программирование](questions.md/#Функциональное-программирование)
    ...
    + [Назовите несколько методов, которые используются для реализации функционально-ориентированного программирования в Python](questions.md/#Назовите-несколько-методов-которые-используются-для-реализации-функционально-ориентированного-программирования-в-Python)
  ...
  * [GIL, потоки, процессы](questions.md/#GIL-потоки-процессы)
    + [В чем разница между процессом и потоком](questions.md/#В-чем-разница-между-процессом-и-потоком)
    + [Что такое синхронный код](questions.md/#Что-такое-синхронный-код)
    + [Что такое асинхронный код](questions.md/#Что-такое-асинхронный-код)
    + [Что такое GIL? Как работает? Какие у него есть проблемы? Хорошо или плохо для разработки?](questions.md/#Что-такое-GIL-Как-работает-Какие-у-него-есть-проблемы-Хорошо-или-плохо-для-разработки)
    ...
    + [Что такое жизненный цикл потоков](questions.md/#Что-такое-жизненный-цикл-потоков)
...
- [Django](questions.md/#Django)
  * [Сравни Django vs FastAPI](questions.md/#Сравни-Django-vs-FastAPI)
  * [`select_related, prefectch_related, select_for_update`](questions.md/#select_related-prefectch_related-select_for_update)
  * [Какая архитектура у Django?](questions.md/#Какая-архитектура-у-Django)
  * [Через какие компоненты идет request в Django?](questions.md/#Через-какие-компоненты-идет-request-в-Django)
  * [Какие минусы видишь в Django, где бы использовал ее, а где нет?](questions.md/#Какие-минусы-видишь-в-Django-где-бы-использовал-ее-а-где-нет)
    + [Минусы Django](questions.md/#Минусы-Django)
    + [Где использовать Django](questions.md/#Где-использовать-Django)
    + [Где не стоит использовать Django](questions.md/#Где-не-стоит-использовать-Django)
  * [F, Q объекты, Annotate](questions.md/#F-Q-объекты-Annotate)
  * [Как исполняются queryset и цикл жизни?](questions.md/#Как-исполняются-queryset-и-цикл-жизни)
  * [**`bulk_create, bulk_save`** - как устроены, как самому сделать и что просиходит на уровне SQL](questions.md/#bulk_create-bulk_save---как-устроены-как-самому-сделать-и-что-просиходит-на-уровне-SQL)
  * [Как реализовать having или distinct на ORM?](questions.md/#Как-реализовать-having-или-distinct-на-ORM)
  * [Делал ли django migrations, писал ли свои?](questions.md/#Делал-ли-django-migrations-писал-ли-свои)
  * [Блокировки, transaction.atomic() - что использовал? Когда возникает?](questions.md/#Блокировки-transactionatomic---что-использовал-Когда-возникает)
  ...
  * [Приведите примеры популярных фреймворков Python](questions.md/#Приведите-примеры-популярных-фреймворков-Python)
...
- [Общее](questions.md/#Общее)
  ...
  * [Какие принципы программирования вы знаете](questions.md/#Какие-принципы-программирования-вы-знаете)
    ...
    + [Dependency Injection](questions.md/#Dependency-Injection)
...
- [БД](questions.md/#БД)
  * [Медленный запрос, что делать?](questions.md/#Медленный-запрос-что-делать)
  * [Что такое СУБД, для чего используется? Назови примеры СУБД.](questions.md/#Что-такое-СУБД-для-чего-используется-Назови-примеры-СУБД)
  * [Что такое транзакция. Какие у неё есть свойства (ACID)](questions.md/#Что-такое-транзакция-Какие-у-неё-есть-свойства-ACID)
  * [Какие команды управления транзакциями вы знаете](questions.md/#Какие-команды-управления-транзакциями-вы-знаете)
  * [Что такое уровни изоляции транзакций. Какие они бывают](questions.md/#Что-такое-уровни-изоляции-транзакций-Какие-они-бывают)
  * [Что такое вложенные транзакции](questions.md/#Что-такое-вложенные-транзакции)
  * [Что такое гонка транзакций (race condition)? Как предотвратить?](questions.md/#Что-такое-гонка-транзакций-race-condition-Как-предотвратить)
